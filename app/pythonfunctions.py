# Starting code by CS For Insight (Summer19 - JG)

#
# Name(s): Saatvik Sejpal
#
...
def substitute(old_text, dictionary_of_substitutions):
    ...
    # use re.sub
    new_text = old_text
    for key in dictionary_of_substitutions:
        new_text = re.sub( key, dictionary_of_substitutions[key], new_text )
